...
?>
  <FORM ACTION="index.php" METHOD="POST" NAME="formulario">
    ...
    <div id="container">
      <div id="content">
        ...
        <h2><a name="multiple-sortable-select" class="anchor" href="#multiple-sortable-select">Multiple Sortable Select (requires JQuery UI and <i>.chosen-sortable</i> class)</a></h2>

      <div class="side-by-side clearfix">
        <div>
          <em>Into This</em>
          <select data-placeholder="Choose a Country..." class="chosen-select chosen-sortable" multiple style="width:350px;" tabindex="4" name="paises">
            <option value=""></option>
  ...
  <script src="jquery-chosen-sortable.js" type="text/javascript"></script>
  ...
  <script type="text/javascript">
    ...
    for (var selector in config) {
      var self = $(selector);
      self.chosen(config[selector]).chosenSortable();
    }
  </script>
  </form>
  <div class="oss-bar">
